                ...
                <div id="home-slick">
                    ...
                    <div class="banner banner-1">
                        ...
                        <div class="banner-caption text-center">
                            ...
                            <h3 class="font-weak" style="color30323a;">Makanan Khas Indonesia</h3>
                    ...
                    <div class="banner banner-1">
                        ...
                        <div class="banner-caption">
                            <h1 class="primary-color">Makanan Khas Indonesia<br><span class="white-color font-weak">Up to 50% OFF</span></h1>
                            <button class="primary-btn">Jajanan Tradisional</button>
                        </div>
                    </div>
                    <!-- /banner -->
